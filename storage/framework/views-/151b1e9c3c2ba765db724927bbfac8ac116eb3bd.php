            ...
            <div class="row">
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                        ...
                        <p class="p-large">Join us to tackle data science, analytics, and machine learning challenges.</p>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <div class="img-wrapper">
                            <img class="img-fluid" src="https://67211654735dd822d79ac35c--tangerine-genie-222549.netlify.app/images/header-software-app.png" alt="alternative">
                        </div> <!-- end of img-wrapper -->
                        <!-- You can add additional relevant images if needed -->
...
<?php /**PATH /home/bandomer/Thisnet/mynetwork/resources/views/dashboard.blade.php ENDPATH**/ ?>