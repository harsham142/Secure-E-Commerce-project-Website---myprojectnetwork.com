...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto mt-8">
        <h2 class="text-2xl font-bold text-center">Visualization (<?php echo e($track); ?> of 3 problems done)</h2>
    ...
    <script>
        ...
        const track = <?php echo json_encode($track, 15, 512) ?>; // Correctly pass the PHP variable to JavaScript
        ...
        function generateCharts(value) {
            const progress = value * 33.33; // Max is 100 (for 3 problems)
...
<?php /**PATH /home/bandomer/Thisnet/mynetwork/resources/views/home/track.blade.php ENDPATH**/ ?>