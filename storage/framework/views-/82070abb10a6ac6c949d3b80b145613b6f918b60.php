...
<body class="flex flex-col min-h-screen bg-gray-100">
    ...
    <div class="container mx-auto flex flex-col md:flex-row mt-4 overflow-hidden">
        <div class="input-area flex-1 bg-green-100 p-4 border-b md:border-b-0 md:border-r border-gray-300">
            <h2 class="text-lg font-semibold text-green-800"><?php echo e($problem->title); ?></h2>
            <p class="text-gray-700 mb-4"><?php echo e($problem->description); ?></p>

            <textarea id="code" name="code" class="w-full border border-green-500 p-2 rounded resize-none h-auto" placeholder="Write your code here..." required><?php echo e(old('code', '')); ?></textarea>
    ...
    $(document).ready(function() {
        ...
        var problem_solution = <?php echo json_encode($problem_solution, 15, 512) ?>; // Adjust this as needed for your expected format
...
<?php /**PATH /home/bandomer/Thisnet/mynetwork/resources/views/home/solve.blade.php ENDPATH**/ ?>